...
# MODEL_PATH = r"D:\emotion detection\models\cnn_emotion_model2.h5"
# DATASET_PATH = r"D:\emotion detection\datasets\msd\Last.fm_data.csv"
...
#     return jsonify({
#         "mood": current_mood,  # Return actual mood including "None"
...
#         # Apply CLAHE for better contrast in different lighting
...
#             # Extract face ROI with padding for better emotion detection
#             padding = int(0.1 * h)
#             y1 = max(0, y - padding)
...
#             # Preprocessing for better emotion recognition
...
#             # Apply histogram equalization on normalized image
...
#                 # Only update if confidence is reasonable (above 30% for better accuracy)
#                 if confidence > 0.30:
#                     emotion_buffer.append(detected)
#                     # Wait for enough samples before setting mood
...
#                 # Show top 3 emotions for debugging
