            ...
            <div className="hidden lg:flex flex-col justify-center items-center bg-[#FACC55] border-r-[3px] border-black p-8 relative overflow-hidden">
                <div className="relative z-10 text-center space-y-4 max-w-sm">
                    ...
                    <h1 className="text-3xl md:text-4xl font-black uppercase leading-tight tracking-tight">
                        Welcome <br /> <span className="text-white text-stroke-2">Back</span>
                    </h1>
                    <p className="text-base font-bold text-black/80">
                        Your daily mood journal is waiting for you.
                    </p>
                </div>

                {/* Decorative Elements */}
                <div className="absolute top-10 left-10 w-16 h-16 bg-[#A78BFA] border-[3px] border-black rounded-full opacity-50 animate-bounce delay-100"></div>
                <div className="absolute bottom-20 right-20 w-24 h-24 bg-[#3DD598] border-[3px] border-black rounded-none rotate-12 opacity-50"></div>
                <div className="absolute top-1/2 -right-12 w-32 h-32 bg-white border-[3px] border-black rounded-full opacity-20"></div>
            </div>
            ...
            <div className="flex flex-col justify-center items-center p-6 lg:p-12 bg-white">
                <div className="w-full max-w-md space-y-6">
                    <div className="text-center lg:text-left">
                        <h2 className="text-2xl font-black uppercase mb-1">Login</h2>
                    ...
                    <div className="relative">
                        ...
                        <div className="relative flex justify-center text-sm">
                            <span className="bg-white px-4 font-black text-black/40 uppercase tracking-widest">Or continue with</span>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <div className="space-y-2">
                            <div className="flex justify-between items-center ml-1">
                                ...
                                <Link
                                    ...
                                    className="text-sm font-bold text-[#A78BFA] hover:text-black hover:underline transition-colors"
                                >
                                    Forgot Password?
                                </Link>
                            </div>
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    placeholder="••••••••"
                                    required
                                    className="w-full bg-[#FAFAFA] border-[3px] border-black/10 rounded-xl py-4 pl-12 pr-12 font-bold focus:outline-none focus:border-black focus:bg-white focus:shadow-[4px_4px_0px_0px_#000] transition-all placeholder:text-black/20"
                                />
                                <button
                                    type="button"
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-[#FACC55] text-black font-black text-lg py-3 border-[3px] border-black rounded-xl shadow-[4px_4px_0px_0px_#000] hover:shadow-[8px_8px_0px_0px_#000] hover:translate-y-[-4px] active:translate-y-0 active:shadow-none disabled:opacity-70 disabled:cursor-not-allowed transition-all flex items-center justify-center gap-2 mt-4 uppercase tracking-wide"
                        >
                            {loading ? <Loader2 className="w-6 h-6 animate-spin" /> : <>Sign In <ArrowRight className="w-6 h-6" /></>}
                        </button>
                    </form>
                    ...
                    <div className="text-center font-bold text-lg">
                        <p className="text-black/60">
                            ...
                            <Link href="/signup" className="text-black underline decoration-2 hover:bg-[#A78BFA] hover:text-white px-2 py-0.5 rounded-md transition-colors">
                                Sign up now
                            </Link>
                        </p>
                    </div>
